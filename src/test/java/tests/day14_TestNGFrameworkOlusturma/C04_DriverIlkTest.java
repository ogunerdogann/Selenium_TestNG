...
public class C04_DriverIlkTest {
    /*
        POM'de driver olusturmak icin inheritence ile kullandigimiz TestBase class'i yerine
        static yollarla ulasabilecegimiz bir method kullanilmasi tercih edilmistir.
        Driver bizim icin cok önemli oldugundan driver icin bagimsiz bir class olusturacagiz.
     */
    @Test
    public void test01(){
